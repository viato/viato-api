        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContributionPipelines_Organizations_DestinationOrganization~",
                        column: x => x.DestinationOrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContributionPipelines_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContributionPipelines_Organizations_SourceOrganizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContributionPipelines_DestinationOrganizationId",
                table: "ContributionPipelines",
                column: "DestinationOrganizationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContributionPipelines_OrganizationId",
                table: "ContributionPipelines",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_ContributionPipelines_SourceOrganizationId",
                table: "ContributionPipelines",
